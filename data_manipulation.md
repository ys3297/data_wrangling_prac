...
``` r
litters_clean_names = janitor::clean_names(litters_df)
litters_selected = select(litters_clean_names, -pups_survive)
litters_mutated = mutate(litters_selected, wt_gain = gd18_weight - gd0_weight)
litters_no_missing = drop_na(litters_mutated, gd0_weight)
```
